...
export const Foo = () => (
  <>
    ...
    <meta
      content="An online playground to convert HTML to JSX"
      name="description"
    />
    <meta name="og:url" content="https://transform.tools/html-to-jsx" />
    <meta name="og:title" content="HTML to JSX" />
    <meta
      name="og:description"
      content="An online playground to convert HTML to JSX"
    />
    ...
    <meta name="twitter:title" content="HTML to JSX" />
    <meta
      name="twitter:description"
      content="An online playground to convert HTML to JSX"
    />
    <meta name="twitter:image" content="https://transform.tools/cover.png" />
    ...
    <link
      rel="preload"
      href="/_next/static/css/7a0d3d979ec7dedaa040.css"
      as="style"
    />
    <Link
      rel="stylesheet"
    ...
    <link
      rel="preload"
      href="/_next/static/chunks/webpack-30e546b380e76dd93e87.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/framework.1ca75fa9036fa61e735a.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/commons.69b28a3d22dcc903340f.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/main-41295dbbdde00efaf5b9.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/b1542cc239bf56c8a14913c0a930efe682b5cf86.0cf7ac768af42e34c682.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/pages/_app-ba19da7795912b98abb9.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/5f58523c0e7f8a1496e44fb3aa9708ae212b3a59.a2080e69844c4d143224.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/660e4eb6ff9bfc5ada3336b97898f9da2417241e.891e51daa2377cd2ef97.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/3bf0f147478403e756586f2776b6fc676a4e2c61.187805c46b9f9bc13249.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/427cd0f733fffc831e61cbecc7a9960242333cba.dc99db14713c9922eff4.js"
      as="script"
    />
    <link
      rel="preload"
      href="/_next/static/chunks/pages/html-to-jsx-58093e90f596d0d1479e.js"
      as="script"
    />
    <div id="__next">
      <header className="css-nil dspl_flex algn-itms_center flx-drct_row h_40px bg-clr_0e7ccf pr_20px box-szg_border-box">
        <div className="logo-transform css-nil flx_1 dspl_flex pl_20px pr_20px box-szg_border-box">
          <svg
        ...
        <div className="css-nil dspl_flex algn-itms_center box-szg_border-box">
          <button
            className="css-69cngj fnt-fam_b77syt mt_0px fnt-sze_12px f-wght_500 ln-ht_20px ltr-spc_0 btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_0px pl_0px ml_0px mr_10px mb_0px h_20px pst_relative dspl_flex algn-itms_center flx-wrap_nowrap w_20px just-cnt_center box-szg_border-box"
            aria-describedby="evergreen-tooltip-29"
          >
            <svg
              data-icon="moon"
              style={{ fill: "#66788A" }}
              viewBox="0 0 16 16"
              className="w_12px h_12px box-szg_border-box"
            >
              <path
        ...
        <div className="css-nil dspl_flex algn-itms_center box-szg_border-box">
          ...
          <a href="https://github.com/ritz078/transform" target="_blank">
            <button className="css-1ii3p2c css-1fj6zxo fnt-fam_b77syt mt_0px fnt-sze_14px f-wght_500 ln-ht_40px ltr-spc_-0-05px btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_20px pl_20px ml_0px mr_0px mb_0px h_40px pst_relative dspl_inline-flex algn-itms_center flx-wrap_nowrap box-szg_border-box">
              GitHub
            </button>
          </a>
        </div>
      </header>
      <div className="light css-nil bg-clr_FFFFFF dspl_flex flx-drct_row box-szg_border-box">
        <div className="css-nil b-rgt_1px-solid-E4E7EB w_240px h_jlh3fd dspl_flex flx-drct_column pt_20px bg-clr_FFFFFF box-szg_border-box">
          <div className="css-nil pl_15px pr_15px box-szg_border-box">
            <div
              role="combobox"
              aria-expanded="false"
              aria-haspopup="listbox"
              aria-labelledby="downshift-6-label"
              className="css-nil w_100prcnt box-szg_border-box"
            >
              <div className="pst_relative dspl_inline-flex h_32px w_100prcnt mb_10px box-szg_border-box">
                <div className="h_32px w_32px ptr-evts_none pst_absolute dspl_flex just-cnt_center algn-itms_center box-szg_border-box">
                  <svg
                    data-icon="search"
                    style={{ fill: "#66788A" }}
                    viewBox="0 0 16 16"
                    className="z-idx_3 w_12px h_12px box-szg_border-box"
                  >
                    <path
                ...
                <input
                  type="search"
                  className="css-5ljhhe color_425A70 fnt-fam_b77syt fnt-sze_12px f-wght_400 ln-ht_16px ltr-spc_0 w_100prcnt h_32px pl_32px pr_10px bblr_3px bbrr_3px btlr_3px btrr_3px box-szg_border-box"
                  placeholder="Search"
                  spellCheck="true"
                  aria-invalid="false"
                  defaultValue=""
          ...
          <div className="css-nil dspl_flex flx_1 ovflw-y_scroll flx-drct_column pb_10px box-szg_border-box">
            <div className="css-nil pl_10px pr_10px mt_15px mb_2px box-szg_border-box">
              <h2 className="mt_0px mb_0px fnt-sze_14px f-wght_600 ln-ht_20px ltr-spc_-0-05px fnt-fam_b77syt color_234361 ml_5px box-szg_border-box">
                SVG
              </h2>
            </div>
            <a style={{ textDecoration: "none" }} href="/">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JSX
                </span>
              </div>
            </a>
            <a style={{ textDecoration: "none" }} href="/svg-to-react-native">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to React Native
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/html-to-jsx">
              <div className="css-1mja1br b-lft_3px-solid-009688 pl_16px pb_3px pt_3px bg-clr_f3f3f3 box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JSX
                </span>
              </div>
            </a>
            <a style={{ textDecoration: "none" }} href="/html-to-pug">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Pug
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-big-query">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Big Query Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-flow">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Flow
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-go-bson">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Go Bson
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-go">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Go Struct
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-graphql">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to GraphQL
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-io-ts">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to io-ts
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-java">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Java
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-jsdoc">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JSDoc
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-json-schema">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JSON Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-kotlin">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Kotlin
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-mongoose">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Mongoose Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-mysql">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to MySQL
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-proptypes">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to React PropTypes
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-rust-serde">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Rust Serde
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-sarcastic">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Sarcastic
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-toml">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to TOML
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-typescript">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to TypeScript
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-yaml">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to YAML
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/json-to-zod">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Zod Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="json-schema-to-zod">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Zod Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/css-to-js">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JS Objects
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/css-to-tailwind">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to TailwindCSS
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/js-object-to-json">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JSON
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/graphql-to-components">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Components
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/graphql-to-flow">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Flow
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/graphql-to-java">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to JAVA
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/graphql-to-schema-ast">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Schema AST
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/graphql-to-typescript">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to TypeScript
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/jsonld-to-compacted">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Compacted
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/jsonld-to-expanded">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Expanded
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/jsonld-to-flattened">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Flattened
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/jsonld-to-framed">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Framed
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/jsonld-to-nquads">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to N-Quads
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="jsonld-to-normalized">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Normalized
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/typescript-to-flow">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Flow
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/typescript-to-zod">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to Zod Schema
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/flow-to-javascript">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to plain JavaScript
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/flow-to-typescript">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  to TypeScript
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/cadence-to-go">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  Cadence to Go
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/markdown-to-html">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  Markdown to HTML
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/toml-to-json">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  TOML to JSON
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/toml-to-yaml">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  TOML to YAML
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/xml-to-json">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  XML to JSON
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/yaml-to-json">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  YAML to JSON
                </span>
            ...
            <a style={{ textDecoration: "none" }} href="/yaml-to-toml">
              <div className="css-1mja1br b-lft_3px-solid-transparent pl_16px pb_3px pt_3px box-szg_border-box">
                <span className="color_425A70 fnt-fam_b77syt fnt-sze_13px f-wght_400 ln-ht_20px ltr-spc_-0-05px box-szg_border-box">
                  YAML to TOML
                </span>
          ...
          <div className="css-nil b-top_1px-solid-E4E7EB box-szg_border-box">
            <a
            ...
            >
              <img
                ...
                alt="Vercel"
                style={{ height: 40, display: "block", margin: "10px auto 0" }}
              />
            </a>
            <h2 className="mt_0px mb_0px fnt-sze_14px f-wght_600 ln-ht_20px ltr-spc_-0-05px fnt-fam_b77syt color_234361 pb_15px pt_15px txt-algn_center box-szg_border-box">
              Created by{/* */}{" "}
        ...
        <div className="css-nil dspl_flex flx-drct_row ovflw-x_hidden ovflw-y_hidden flx_1 h_jlh3fd box-szg_border-box">
          <div className="css-nil b-rgt_1px-solid-E4E7EB dspl_flex flx_1 flx-drct_column ovflw-x_hidden ovflw-y_hidden box-szg_border-box">
            <div className="css-nil dspl_flex flx_1 flx-drct_column ovflw-x_hidden ovflw-y_hidden box-szg_border-box">
              <div className="css-nil b-btm_1px-solid-E4E7EB dspl_flex h_40px pl_10px pr_10px algn-itms_center z-idx_2 bg-clr_FFFFFF flx-srnk_0 box-szg_border-box">
                <div className="css-nil flx_1 box-szg_border-box">
                  <h2 className="mt_0px mb_0px fnt-sze_16px f-wght_500 ln-ht_20px ltr-spc_-0-05px fnt-fam_b77syt color_234361 box-szg_border-box">
                    HTML
                  </h2>
                </div>
                <button className="css-69cngj fnt-fam_b77syt mt_0px fnt-sze_12px f-wght_500 ln-ht_28px ltr-spc_0 btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_14px pl_14px ml_0px mr_10px mb_0px h_28px pst_relative dspl_inline-flex algn-itms_center flx-wrap_nowrap box-szg_border-box">
                  <svg
                    data-icon="cog"
                    style={{ fill: "currentColor" }}
                    viewBox="0 0 16 16"
                    className="ml_-3px mr_8px w_12px h_12px box-szg_border-box"
                  >
                    <path
                ...
                <button
                  className="css-69cngj fnt-fam_b77syt mt_0px fnt-sze_12px f-wght_500 ln-ht_28px ltr-spc_0 btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_0px pl_0px ml_0px mr_10px mb_0px h_28px pst_relative dspl_flex algn-itms_center flx-wrap_nowrap w_28px just-cnt_center box-szg_border-box"
                  role="button"
                  aria-haspopup="true"
                  aria-describedby="evergreen-tooltip-30"
                >
                  <svg
                    data-icon="upload"
                    style={{ fill: "#66788A" }}
                ...
                <button
                  className="css-5pze3j fnt-fam_b77syt mt_0px fnt-sze_12px f-wght_500 ln-ht_28px ltr-spc_0 btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_0px pl_0px ml_0px mr_10px mb_0px h_28px pst_relative dspl_flex algn-itms_center flx-wrap_nowrap w_28px just-cnt_center box-szg_border-box"
                  aria-describedby="evergreen-tooltip-31"
                >
                  <svg
                    data-icon="trash"
                    style={{ fill: "currentColor" }}
          ...
          <div className="css-nil dspl_flex flx_1 pst_relative box-szg_border-box">
            <div className="css-nil dspl_flex flx_1 flx-drct_column ovflw-x_hidden ovflw-y_hidden box-szg_border-box">
              <div className="css-nil b-btm_1px-solid-E4E7EB dspl_flex h_40px pl_10px pr_10px algn-itms_center z-idx_2 bg-clr_FFFFFF flx-srnk_0 box-szg_border-box">
                <div className="css-nil flx_1 box-szg_border-box">
                  <h2 className="mt_0px mb_0px fnt-sze_16px f-wght_500 ln-ht_20px ltr-spc_-0-05px fnt-fam_b77syt color_234361 box-szg_border-box">
                ...
                <button className="css-nwvixr fnt-fam_b77syt mt_0px fnt-sze_12px f-wght_500 ln-ht_28px ltr-spc_0 btrr_3px bbrr_3px btlr_3px bblr_3px pt_0px pb_0px pr_14px pl_14px ml_0px mr_10px mb_0px h_28px pst_relative dspl_inline-flex algn-itms_center flx-wrap_nowrap box-szg_border-box">
                  <svg
                    data-icon="duplicate"
                    style={{ fill: "currentColor" }}
                    viewBox="0 0 16 16"
